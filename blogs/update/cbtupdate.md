...
1. 因本次功能新增较多，建议卸载旧版本后安装。
2. 从本版本开始，我们放开了对大家的截图外传限制。这意味着你可以发布截图到本群以外的位置帮助我们宣传，但是我们依旧要求大家不外传包体、不外借测试账号，若被发现则永久禁止参与先锋测试。
3. 欢迎大家通过正常手段在已适配 V2 的资源中多多发布评论，进行评论区压力测试，这有利于我们进行服务器安全与稳定性评估。测试账号及评论区数据将不会在正式版发布时顺延，大家方可放心尝试。
4. 测试阶段会员不开放购买，所以会员页面跳转出去无购买途径。
5. 测试阶段大陆资源镜像不开放使用。
6. i18n 忘记同步了，你们忍一下。
